            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="mt-20 mb-10">
                        <a href={`https://github.com/${appConfig.githubUsername}`} target="_blank" rel="noopener noreferrer"
                            className="flex-1 text-center border-1 border-sky-500 hover:bg-sky-400 p-2 rounded-3xl text-white text-lg p-4 font-bold transition">
                            <i className="fas fa-external-link-alt mr-2"></i>View all projects
                        </a>
                    </div>
                </>
            )}
